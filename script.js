...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const PATHWAYS = {
    ...
    A3: {
      ...
      continueLabel: "Risk category selected → continue",
      next: "A4",
    },
    A4: {
      id: "A4",
    ...
    A_INO_OBS_BRANCH: {
      ...
      options: [
        ...
        { label: "No", next: "A_INO_OBS_NOHIGHRISK_OPTIONS" },
      ],
    },

    A_INO_OBS_NOHIGHRISK_OPTIONS: {
      id: "A_INO_OBS_NOHIGHRISK_OPTIONS",
      type: "decision",
  ...
  const MODALITIES = {
    ...
    PET: {
      name: "Stress PET MPI",
      summary:
        "Rest/stress PET myocardial perfusion imaging detects perfusion abnormalities and LV function; MBFR adds diagnostic/prognostic value.",
      bullets: [
